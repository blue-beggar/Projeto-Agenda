 ...
 * @author cg3017885
 */
public class Contatos_Tela extends javax.swing.JFrame {

    /**
     * Creates new form Contatos
     */
    public Contatos_Tela() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Contatos_Tela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Contatos_Tela().setVisible(true);
            }
        });
    }
